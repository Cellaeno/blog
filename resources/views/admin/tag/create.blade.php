                    ...
                    <div class=" form-grids row form-grids-right">
                      <div class="widget-shadow " data-example-id="basic-forms">
                        <div class="form-title">
                          <h4>添加云标签 :</h4></div>
                        <div class="form-body">
                          <form action="/admin/tag/store" method="post" enctype="multipart/form-data" class="form-horizontal">
                            {{ csrf_field() }}
                            <div class="form-group">
                              <label for="tname" class="col-sm-2 control-label">云标签名</label>
                              <div class="col-sm-9">
                                <input type="text" class="form-control" value="{{ old('tname') }}" name="tname" id="tname" placeholder="标签名"></div>
                            </div>
                            <div class="form-group">
                              <label for="bgcolor" class="col-sm-2 control-label">背景色</label>
                              <div class="col-sm-9" style="width:30%;">
                                <input type="color" class="form-control" id="bgcolor" value="{{ old('bgcolor') }}" name="bgcolor" placeholder="云标签的背景色"></div>
                            </div>
